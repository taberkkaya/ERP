namespace ERPServer.Domain.Mail;

/// <summary>
/// Giden maillerin ortak iskeleti.
///
...
public static class MailTemplate
{
    ...
    private const string Brand = "#f97316";
                          ...
                          <table role="presentation" cellpadding="0" cellspacing="0">
                            <tr>
                              <td style="background:{Brand};border-radius:8px;width:34px;height:34px;
                                         ...
                                         font-family:{Font};font-size:17px;font-weight:700;">T</td>
                              <td style="padding-left:12px;font-family:{Font};">
                                <div style="color:#ffffff;font-size:16px;font-weight:700;line-height:1.2;">Tezgah</div>
                                <div style="color:{Muted};font-size:12px;line-height:1.4;">üretim yönetimi</div>
                              </td>
                            </tr>
                          </table>
                        </td>
    ...
    public static string Code(string code) =>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="margin:24px 0;">
          <tr>
            <td style="background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;
                       padding:16px 26px;font-family:{Font};font-size:30px;font-weight:700;
                       letter-spacing:8px;color:#c2410c;">{code}</td>
          </tr>
        </table>
        """;
