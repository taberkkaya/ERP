...
///
/// Kod isteme ve oturum açma istekleri jeton taşımadan geldiği için
/// <c>ConnectionStringResolver</c> bunları zaten ana veritabanına yönlendiriyor.
///
...
public sealed class DemoVisitor : Entity
{
    ...
    /// <summary>
    /// Kaydın açıldığı an. Taban sınıfta böyle bir alan yok; ziyaretçi listesini
    /// sıralayabilmek için burada tutuluyor.
    /// </summary>
